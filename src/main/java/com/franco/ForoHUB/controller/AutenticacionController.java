...
import com.franco.ForoHUB.infra.security.DatosTokenJWT;
import com.franco.ForoHUB.infra.security.TokenService;
...
public class AutenticacionController {
    ...
    @PostMapping
    public ResponseEntity iniciarSesion(@Valid @RequestBody DatosLoginUsuario datos){
